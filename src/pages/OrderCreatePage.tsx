...
import { createOrder } from "../domains/order/order-api";
import type {
  PickupDelivery,
  Payment,
  OrderStatus,
...
function OrderCreatePage() {
  ...
  const [formData, setFormData] = useState<OrderCreateFormData>({
    po: "",
    buyer: {
      personName: "",
    },
              ...
              <Stack spacing={2}>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={formData.recipient.address?.preferred || false}
                        onChange={(e) =>
                          handlePersonAddressChange(
                            "recipient",
                            "preferred",
